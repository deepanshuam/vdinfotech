                    ...
                    <Slider {...settings} className={` ${styles.certificate_img}`}>
                        <div className={styles.slide_item}>
                            <li className='d-flex justify-content-center align-items-center'>
                                <img src="/images/New/yt.png" alt="YouTube Certified" className={styles.certificationLogo} />    
                            </li>
                        </div>
                        <div className={styles.slide_item}>
                            <li className='d-flex justify-content-center align-items-center'>
                                <img src="/images/New/bing.png" alt="Bing Certified" className={styles.certificationLogo} />
                            </li>
                        </div>
                        <div className={styles.slide_item}>
                            <li className='d-flex justify-content-center align-items-center'>
                                <img src="/images/New/google.png" alt="Google AdWords Certified" className={styles.certificationLogo} />
                            </li>
                        </div>
                        <div className={styles.slide_item}>
                            <li className='d-flex justify-content-center align-items-center'>
                                <img src="/images/New/ga.png" alt="Google Analytics Certified" className={styles.certificationLogo} />
                            </li>
                        </div>
                        <div className={styles.slide_item}>
                            <li className='d-flex justify-content-center align-items-center'>
                                <img src="/images/New/pr.png" alt="Google Analytics Certified" className={styles.certificationLogo} />
                            </li>
                        </div>
                    </Slider>
                </div>
